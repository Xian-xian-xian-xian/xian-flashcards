    ...
    <section className="stack">
      <div className={`hero-panel daily-hero ${props.dailyTask.completed ? "complete" : ""}`}>
        ...
        <div>
          ...
          <p>复习 {props.dailyTask.review_completed} 张 · 新学 {props.dailyTask.new_completed} 张</p>
      ...
      <div className="task-strip">
        ...
        <TaskItem icon={<ListChecks />} label="今日学习" value={`复习 ${props.dailyTask.review_completed} 张 · 新学 ${props.dailyTask.new_completed} 张`} done={props.dailyTask.completed} />
                        ...
                        <MarkdownText
                          ...
                          renderBlank={(key) => (
                            <input
                              ...
                              value={splitBlankAnswers(answer, currentBlankCount)[blankInputIndex(key)] ?? ""}
                              onChange={(event) => {
                                setAnswer(setBlankAnswerPart(answer, currentBlankCount, blankInputIndex(key), event.target.value));
                                setChecked(null);
                              }}
                              aria-label="填空答案"
                              autoComplete="off"
